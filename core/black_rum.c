...
/* Reset the parsing context of a BLACK_RUM environment */
static _parsing_context_t* _reset_parsing_context(_parsing_context_t* context) {
	_ls_node_t* imp = 0;
...
/* Destroy the parsing context of a BLACK_RUM environment */
static void _destroy_parsing_context(_parsing_context_t* _mb_unaligned * context) {
	if(!context || !(*context))
		return;
...
/* Register a function to a BLACK_RUM environment */
static int _register_func(mb_interpreter_t* s, char* n, mb_func_t f, bool_t local) {
	int result = 0;
	_ht_node_t* scope = 0;
	_ls_node_t* exists = 0;
...
/* Remove a function from a BLACK_RUM environment */
static int _remove_func(mb_interpreter_t* s, char* n, bool_t local) {
	int result = 0;
	_ht_node_t* scope = 0;
	_ls_node_t* exists = 0;
...
/* Get the version number of this BLACK_RUM system */
unsigned long mb_ver(void) {
	return _MB_VERSION;
}

/* Get the version text of this BLACK_RUM system */
const char* mb_ver_string(void) {
	return _MB_VERSION_STRING;
}

/* Initialize the BLACK_RUM system */
int mb_init(void) {
	if(_exp_assign)
		return MB_FUNC_ERR;
