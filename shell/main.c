/*
**
** This source file is part of BLACK_RUM
**
** For the latest info, see https://github.com/crazywolf132/black_rum/
**
** Copyright (C) 2017 - 2022 Brayden Moon
**
*/
...
#ifdef MB_OS_WIN
#	define _BIN_FILE_NAME "black_rum"
#elif defined MB_OS_MAC
#	define _BIN_FILE_NAME "black_rum_mac"
#else
#	define _BIN_FILE_NAME "black_rum_bin"
#endif
...
static void _show_tip(void) {
	_printf("BLACK_RUM Shell - %s\n", mb_ver_string());
	_printf("Copyright (C) 2017 - 2022 Brayden Moon. All Rights Reserved.\n");
	_printf("For more information, see https://github.com/crazywolf132/black_rum/.\n");
...
static void _show_help(void) {
	...
	_printf("  RM    - Remove line by number\n");
	_printf("          Usage: RM n, n is line number\n");
...
static int _do_line(void) {
	...
	if(_str_eq(line, "")) {
		...
		_show_help();
	} else if(_str_eq(line, "CLS") || _str_eq(line, "CLEAR")) {
		_clear_screen();
		...
		if(result == MB_FUNC_OK)
			result = mb_run(bas);
		_printf("\n");
	} else if(_str_eq(line, "BYE") || _str_eq(line, "QUIT")) {
		result = MB_FUNC_BYE;
	} else if(_str_eq(line, "LIST") || _str_eq(line, "LS")) {
